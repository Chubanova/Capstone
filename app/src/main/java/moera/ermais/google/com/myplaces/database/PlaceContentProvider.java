...
import static moera.ermais.google.com.myplaces.database.PlaceContract.*;
import static moera.ermais.google.com.myplaces.database.PlaceContract.PlaceEntry.*;
...
public class PlaceContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // Add URI matches
        uriMatcher.addURI(AUTHORITY, PATH_PLACES, PLACES);
        uriMatcher.addURI(AUTHORITY, PATH_PLACES + "/#", PLACE_WITH_ID);
        return uriMatcher;
    }
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case PLACE_WITH_ID:
                ...
                placesDeleted = db.delete(TABLE_NAME, "_id=?", new String[]{id});
                break;
            case PLACES:
                placesDeleted = db.delete(TABLE_NAME, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            case PLACE_WITH_ID:
                ...
                String id = uri.getPathSegments().get(1);
                // Use selections/selectionArgs to filter for this ID
                placesUpdated = db.update(TABLE_NAME, values, "_id=?", new String[]{id});
                break;
            case PLACES:
                placesUpdated = db.update(TABLE_NAME, values, selection, selectionArgs);
                break;
            // Default exception
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
