...
public class Geofencing implements ResultCallback {
    ...
    private static final float GEOFENCE_RADIUS = GEO_ACCURACY * 10 * 10000; // 150 meters
    private static final long GEOFENCE_TIMEOUT = 100; // 0.1 minute
    ...
    public void onResult(@NonNull Result result) {
        Log.d(TAG, String.format("Adding/removing geofence result : %s",
